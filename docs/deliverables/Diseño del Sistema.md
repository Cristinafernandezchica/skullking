...
![Diagrama de Capas](/docs/diagrams/DiagramaDeCapas_v3.png)
...
Las entidades implicadas son: Partida, Ronda, Baza, Mano, Truco, Carta, Jugador, Usuario, Amistad, Chat e Invitacion.
