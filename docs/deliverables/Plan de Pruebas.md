...
| HJA2: Ver estadísticas      | [UTB-7:UserDashBoard.test](../../frontend\src\admin\users\UserDashboard.test.js) | Verifica que un usuario cualquiera puede ver las estadísticas de los usuarios.                      | Implementada  | En frontend|
...
| HJJ16: Jugar partida completa | [UTB-13:PartidaControllerTest](../../src/test/java/es/us/dp1/lx_xy_24_25/your_game_name/partida/PartidaControllerTest.java#L270shouldGanadorPartida) | Verifica que se muestre el ganador/es de la partida al finalizar la última ronda.               | Implementada  | Unitaria en backend   |
...
| HSJ9: Visualizar ranking de usuarios por puntos | [UTB-22:UserDashboard.test.js](../../frontend/src/admin/users/UserDashboard.test.js) | Verifica que se visualice correctamente el ranking de usuarios por puntos en el frontend. | Implementada | Prueba en frontend |
| HSJ10: Visualizar ranking de usuarios por victorias | [UTB-2:UserControllerTests](../../src/test/java/es/us/dp1/lx_xy_24_25/your_game_name/user/UserControllerTests.java#L286shouldGetUsersSortedByWinPercentage) | Verifica que se calcule correctamente el ranking de usuarios por porcentaje de victorias. | Implementada | Unitaria en backend |
| HSJ10: Visualizar ranking de usuarios por victorias | [UTB-22:UserDashboard.test.js](../../frontend/src/admin/users/UserDashboard.test.js) | Verifica que se visualice correctamente el ranking de usuarios por porcentaje de victorias. | Implementada | Prueba en frontend |
| HSJ11: Visualizar estadísticas globales de duración de partidas | [UTB-2:UserControllerTests](../../src/test/java/es/us/dp1/lx_xy_24_25/your_game_name/user/UserControllerTests.java#L508shouldGetTotalTiempoPartidas) | Verifica que se calculen las estadísticas globales de duración de las partidas. | Implementada | Unitaria en backend |
| HSJ11: Visualizar estadísticas globales de duración de partidas | [UTB-22:UserDashboard.test.js](../../frontend/src/admin/users/UserDashboard.test.js) | Verifica que se visualicen correctamente las estadísticas globales de duración de partidas. | Implementada | Prueba en frontend |
| HSJ12: Visualizar estadísticas por usuario de duración de partidas | [UTB-2:UserControllerTests](../../src/test/java/es/us/dp1/lx_xy_24_25/your_game_name/user/UserControllerTests.java#L520shouldGetTotalTiempoPartidasByUserId) | Verifica que se calculen las estadísticas de duración de partidas por usuario. | Implementada | Unitaria en backend |
| HSJ12: Visualizar estadísticas por usuario de duración de partidas | [UTB-22:UserDashboard.test.js](../../frontend/src/admin/users/UserDashboard.test.js) | Verifica que se visualicen correctamente las estadísticas de duración por usuario. | Implementada | Prueba en frontend |
| HSJ13: Visualizar estadísticas globales del número de partidas jugadas | [UTB-2:UserControllerTests](../../src/test/java/es/us/dp1/lx_xy_24_25/your_game_name/user/UserControllerTests.java#L436shouldGetPromedioTiempoPartidas) | Verifica que se obtengan las estadísticas globales del número de partidas jugadas. | Implementada | Unitaria en backend |
| HSJ13: Visualizar estadísticas globales del número de partidas jugadas | [UTB-22:UserDashboard.test.js](../../frontend/src/admin/users/UserDashboard.test.js) | Verifica que se visualicen correctamente las estadísticas globales del número de partidas jugadas. | Implementada | Prueba en frontend |
| HSJ14: Visualizar estadísticas por usuario del número de partidas jugadas | [UTB-2:UserControllerTests](../../src/test/java/es/us/dp1/lx_xy_24_25/your_game_name/user/UserControllerTests.java#L448shouldGetPromedioTiempoPartidasByUserId) | Verifica que se obtengan las estadísticas del número de partidas jugadas por usuario. | Implementada | Unitaria en backend |
| HSJ14: Visualizar estadísticas por usuario del número de partidas jugadas | [UTB-22:UserDashboard.test.js](../../frontend/src/admin/users/UserDashboard.test.js) | Verifica que se visualicen correctamente las estadísticas del número de partidas jugadas por usuario. | Implementada | Prueba en frontend |

### 5.3 Matriz de Trazabilidad entre Pruebas e Historias de Usuario

| Prueba                               | HGJ1 | HGJ2 | HGJ3 | HGJ4 | HGJ5 | HGJ6 | HGA1 | HGA2 | HGA3 | HGA4 | HJA1 | HJA2 | HJJ1 | HJJ2 | HJJ3 | HJJ4 | HJJ5 | HJJ6 | HJJ7 | HJJ8 | HJJ9 | HJJ10 | HJJ11 | HJJ12 | HJJ13 | HJJ14 | HJJ15 | HJJ16 | HJJ17 | HJJ18 | HJJ19 | HSJ1 | HSJ2 | HSJ3 | HSJ4 | HSJ5 | HSJ6 | HSJ7 | HSJ8 | HSJ9 | HSJ10 | HSJ11 | HSJ12 | HSJ13 | HSJ14 |
|-------------------------------------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|------|
| UTB-1:AuthControllerTests           |  X   |  X   |  X   |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |       |       |       |       |       |       |       |       |       |      |      |      |      |      |      |      |      |      |      |      |      |      |      |
| UTB-2:UserControllerTests           |      |      |      |  X   |  X   |  X   |      |  X   |  X   |  X   |      |      |      |      |      |      |      |      |      |      |      |       |       |       |       |       |       |       |       |       |      |      |      |      |      |      |      |      |      |      |  X   |  X   |  X   |  X   |  X   |
...
UTB-14:JugadorRestControllerTest        |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |  X    |       |       |   X   |       |       |       |       |      |      |      |      |      |      |      |      |
...
UTB-22:UserDashboard.test.js       |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |      |       |       |       |       |       |       |       |       |      |      |      |      |      |      |      |      |      |  X   |  X   |  X   |  X   |  X   |  X   |
