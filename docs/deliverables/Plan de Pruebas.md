...
| HGJ5: Editar perfil de usuario        | [UTB-2:UserControllerTests](../../src/test/java/es/us/dp1/lx_xy_24_25/your_game_name/user/UserControllerTests.java#L210shouldUpdateUser) | Verifica que un usuario puede editar su perfil.                                                | Implementada  | De integración backend|
...
| HJJ7: Ver ganador de la baza   | [UTB-5:Truco](../../src/test/java/es/us/dp1/lx_xy_24_25/your_game_name/baza/BazaRestControllerTest.java#L901shouldCalculoGanador) | Verifica que un jugador puede ver el ganador de una baza al finalizarla.                       | Implementada  | Unitaria en backend   |
...
| HJJ15: Salir de sala de espera | [UTB-8:JugadorRestControllerTest](../../src/test/java/es/us/dp1/lx_xy_24_25/your_game_name/jugador/JugadorRestControllerTest.java#shouldSalirSalaEspera) | Verifica que un jugador pueda salir de la sala de espera antes de que la partida comience.      | Implementada  | Unitaria en backend   |
| HJJ16: Ver ganador de la partida | [UTB-16:PartidaServiceTest](../../src/test/java/es/us/dp1/lx_xy_24_25/your_game_name/partida/PartidaServiceTest.java#shouldVerGanadorPartida) | Verifica que se muestre el ganador/es de la partida al finalizar la última ronda.               | Implementada  | Unitaria en backend   |
| HJJ17: Ver bazas ganadas por ronda | [UTB-17:RondaServiceTest](../../src/test/java/es/us/dp1/lx_xy_24_25/your_game_name/ronda/RondaServiceTest.java#shouldVerBazasGanadasPorRonda) | Verifica que los jugadores puedan ver cuántas bazas ha ganado cada uno tras cada ronda.         | Implementada  | Unitaria en backend   |
| HJJ18: Saber ronda y baza actual | [UTB-17:RondaServiceTest](../../src/test/java/es/us/dp1/lx_xy_24_25/your_game_name/ronda/RondaServiceTest.java#shouldSaberRondaBazaActual) | Verifica que los jugadores sepan la ronda y baza actuales durante la partida.     | Implementada  | Unitaria en backend   |
| HJJ19: Listar mis partidas | [UTB-18:PartidaServiceTest](../../src/test/java/es/us/dp1/lx_xy_24_25/your_game_name/partida/PartidaServiceTest.java#shouldListarMisPartidas) | Verifica que un jugador pueda ver un listado de las partidas en las que ha participado.         | Implementada  | Unitaria en backend   |
